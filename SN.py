...
def main(isSend,id,port,pair,message):
    ...
    if(isSend == '1'):
        ...
        trimmed = trimmed[2:]
        msg = "--SN--:Message arrived from " + pair + ": " + trimmed
        print(msg)
        print("----------------------------------------------------")
        ...
        trimmed = trimmed[2:]
        clientMsg = "--SN--:Message arrived from "+ pair+ " node :" + trimmed
        clientIP = "--SN--:Pair IP Address:{}".format(address)
        print(clientMsg)
        print(clientIP)
        ackMessage = "acknowledge packet from SN Node"
