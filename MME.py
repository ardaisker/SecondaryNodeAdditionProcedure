...
def main(isSend,id,port,pair,message):
    ...
    if(isSend == '1'):
        ...
        trimmed = trimmed[2:]
        msg = "--MME--:Message arrived from " + pair + ": " + trimmed
        print(msg)
        print("----------------------------------------------------")
        ...
        trimmed = trimmed[2:]
        clientMsg = "--MME--:Message arrived from "+ pair+ " node :" + trimmed
        clientIP = "--MME--:Pair IP Address:{}".format(address)
        print(clientMsg)
        print(clientIP)
        ackMessage = "acknowledge packet from MME Node"
